...
namespace Vip.Mapper.Tests
{
    ...
    public class ComplexMapTests : TestBase
    {
        ...
        public class MapTestModels
        {
            ...
            {
                [AutoMapper.Id] public int Customer_Id;

                [AutoMapper.Id] public string Customer_Type;
        ...
        public void Can_Map_Complex_Nested_Members()
        {
            ...
            // Act
            var customer = AutoMapper.Map<MapTestModels.CustomerWithOrdersList>(dictionary);
        ...
        public void Can_Detect_Duplicate_Parent_Members_And_Properly_Instantiate_The_Object_Only_Once()
        {
            ...
            // Act
            var customers = AutoMapper.Map<MapTestModels.CustomerWithOrdersList>(listOfDictionaries);
        ...
        public void Can_Handle_Nested_Members_That_Implements_ICollection()
        {
            ...
            // Act
            var customers = AutoMapper.Map<MapTestModels.CustomerWithAnIEnumerableOrdersCollection>(listOfDictionaries);
        ...
        public void Can_Handle_Mapping_Objects_With_Multiple_Identifiers()
        {
            ...
            // Act
            var customers = AutoMapper.Map<MapTestModels.CustomerWithMultipleIdAttributes>(listOfDictionaries);
        ...
        public void Can_Handle_Mapping_Deeply_Nested_Members()
        {
            ...
            // Act
            var customer = AutoMapper.Map<MapTestModels.CustomerWithAnIEnumerableOrdersCollection>(dictionary);
